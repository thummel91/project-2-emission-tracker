      ...
      <div>
        {country !== undefined ? (
          <div>
            <h1>{id}</h1>
            <div className="gas">
              <p>Natural Gas: <br></br>{twoDecimal} kg co2e per €100 </p>
            </div>
          </div>
        ) : (
          <p>
      ...
      <div>
        <div>
          {biomass !== undefined ? (
            <div>
              <div className="gas">
                <p>Biomass: <br></br>{threeDecimal} kg co2 equivalent per €100</p>
              </div>
            </div>
          ) : (
            <p>
              There is no emissions data on electricity generated by biomass in {id}
            </p>
          )}
        </div>
      </div>
      ...
      <div>
        <div>
          {coal !== undefined ? (
            <div>
              <div className="gas">
                <p> Coal:<br></br> {fourDecimal} kg co2e per €100</p>{" "}
              </div>
            </div>
          ) : (
            <p>
      ...
      <div>
        <div>
          {geothermal !== undefined ? (
            <div>
              <div>
                <p> Geothermal: <br></br>{fiveDecimal} kg co2e per €100</p>{" "}
              </div>
            </div>
          ) : (
            <p>
      ...
      <div>
        <div>
          {hydro !== undefined ? (
            <div>
              <div>
                <p> Hydro:<br></br> {sixDecimal} kg co2e per €100</p>{" "}
              </div>
            </div>
          ) : (
            <p>
      ...
      <div>
        <div>
          {nuclear !== undefined ? (
            <div>
              <div>
                <p> Nuclear: <br></br>{sevenDecimal} kg co2e per €100</p>{" "}
              </div>
            </div>
          ) : (
            <p>
      ...
      <div>
        <div>
          {pet !== undefined ? (
            ...
            <p>
              There is no emissions data on electricity generated by Petroleum and other oil derivaties in {id}
            </p>
          )}
        </div>
      </div>
      ...
      <div>
        <div>
          {solar !== undefined ? (
            ...
            <p>
              There is no emissions data on electricity generated by Solarvoltaic in {id}
            </p>
          )}
        </div>
      </div>
      ...
      <div>
        <div>
          {wind !== undefined ? (
            ...
            <p>
              There is no emissions data on electricity generated by Wind in {id}
            </p>
          )}
        </div>
      </div>
